...
#define FLAG_REPEL_ACTIVE                    0x54  // Flag used to toggle new Repel key item
#define FLAG_LURE_ACTIVE                     0x55  // Flag used to toggle new Lure key item
...
#define FLAG_EXP_SHARE                       0x68 // Exp Share flag needed for Gen 6 and later functionality
...
#define FLAG_SAILED_TO_LITTLEROOT            0xE9 // Unused Flag
