...
const u8 gText_RepelActivated[] = _("{PLAYER} activated their Repel.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepelDeactivated[] = _("{PLAYER} deactivated their Repel.{PAUSE_UNTIL_PRESS}");
const u8 gText_LureActivated[] = _("{PLAYER} activated their Lure.{PAUSE_UNTIL_PRESS}");
const u8 gText_LureDeactivated[] = _("{PLAYER} deactivated their Lure.{PAUSE_UNTIL_PRESS}");
